            ...
            <header className="face_elements">
                <div className="containerbox">
                    <div className="insidebox">
                        ...
                        <a href="#f" download="mi-archivo.pdf">
            ...
            <article className="_info_column_handle">
                <div className="paquet">
                    <div>
                        <br />
                        <br />
                        I´m a web developer based in CDMX, with skills to solve
                        problems using programming codes. In 2024 I Finished my
        ...
        <>
            <div className="cbdproject">
                ...
                <div className="fila_2">
                    <h4>CBD commerce</h4>
                    <p>
                        A simple sketch to display information about an online
                        cbd-store on screen.
                    </p>
                    <p>
        ...
        <>
            <div className="handle_pagefoter">
                ...
                <p>
                    ...
                    &nbsp;&nbsp;
                    <a href="https://www.linkedin.com/in/alejandro-robles-s%C3%A1nchez-2a638b27a/">
                ...
                <p>
                    ...
                    &nbsp;&nbsp;
                    <a href="#">alejandro_contact@joserobles.com</a>
                </p>
            </div>
        </>
    );
